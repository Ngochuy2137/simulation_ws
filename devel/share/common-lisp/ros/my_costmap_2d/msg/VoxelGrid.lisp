...
(cl:in-package my_costmap_2d-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <VoxelGrid>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'VoxelGrid)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_costmap_2d-msg:<VoxelGrid> is deprecated: use my_costmap_2d-msg:VoxelGrid instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <VoxelGrid>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_costmap_2d-msg:header-val is deprecated.  Use my_costmap_2d-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <VoxelGrid>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_costmap_2d-msg:data-val is deprecated.  Use my_costmap_2d-msg:data instead.")
  (data m))

(cl:ensure-generic-function 'origin-val :lambda-list '(m))
(cl:defmethod origin-val ((m <VoxelGrid>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_costmap_2d-msg:origin-val is deprecated.  Use my_costmap_2d-msg:origin instead.")
  (origin m))

(cl:ensure-generic-function 'resolutions-val :lambda-list '(m))
(cl:defmethod resolutions-val ((m <VoxelGrid>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_costmap_2d-msg:resolutions-val is deprecated.  Use my_costmap_2d-msg:resolutions instead.")
  (resolutions m))

(cl:ensure-generic-function 'size_x-val :lambda-list '(m))
(cl:defmethod size_x-val ((m <VoxelGrid>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_costmap_2d-msg:size_x-val is deprecated.  Use my_costmap_2d-msg:size_x instead.")
  (size_x m))

(cl:ensure-generic-function 'size_y-val :lambda-list '(m))
(cl:defmethod size_y-val ((m <VoxelGrid>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_costmap_2d-msg:size_y-val is deprecated.  Use my_costmap_2d-msg:size_y instead.")
  (size_y m))

(cl:ensure-generic-function 'size_z-val :lambda-list '(m))
(cl:defmethod size_z-val ((m <VoxelGrid>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_costmap_2d-msg:size_z-val is deprecated.  Use my_costmap_2d-msg:size_z instead.")
  (size_z m))
